...
| aid_bg_upload | str   | 通过已在[https://img.xiaoyuan151.xyz](https://img.xiaoyuan151.xyz)上传的音频设置背景 |
...
| pic_bg_upload | str   | 通过已在[https://img.xiaoyuan151.xyz](https://img.xiaoyuan151.xyz)上传的图片设置背景 |
| text          | str   | 设置文本（如“中考加油!”）                                                          |
| title         | str   | 设置标题文本（如“距中考还有：”）                                                       |
| vid_bg        | str   | 设置网页背景视频（所有视频必须在文件夹bgs下）                                                |
| vid_bg_url    | str   | 自定义视频背景URL                                                              |
| vid_bg_upload | str   | 通过已在[https://img.xiaoyuan151.xyz](https://img.xiaoyuan151.xyz)上传的视频设置背景 |
