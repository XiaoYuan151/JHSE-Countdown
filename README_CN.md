...
参数示例网站（不显示毫秒）：[https://jhsec.xiaoyuan151.top/index.html?no_ms=t](https://jhsec.xiaoyuan151.top/index.html?no_ms=t)
...
| aid_bg_upload | str   | 通过已上传的音频设置背景             |
...
| pic_bg_upload | str   | 通过已上传的图片设置背景             |
